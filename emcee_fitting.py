...
def log_prior(theta, wave_center, Amp_max, m, b, max_b, min_b):
    ...
    left_mu = wave_center - 20  # this is how much mu can vary
    right_mu = wave_center + 20 # this is how much mu can vary
    
    #min and max amplitude of the emission line
    min_A = 0
    max_A = Amp_max * 3
    
    sigma_window_left = 1 #had to change these for the input spectra these are left bounds for sigma
    sigma_window_right = 100 #had to change these for the input spectra these are right bounds for sigma
